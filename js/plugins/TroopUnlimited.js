 ...
 * @author triacontane
 *
 * @help The number of enemy characters which can exceed the maximum value of 8 on the editor
 * You will be able to spawn at once.
 *
 * Additions are made on a troop basis.
 *
 * Include the following in the "Name" of the enemy troop:
 * \add[3] # Add to the original enemy character and add it to the "enemy troop" with ID [3]
 * The specified enemy character will be added in the initial placement.
 *
 * If you want to add more, please specified \add[n] for that amount.
 *
 * Only enemy characters will be added. 
 * It does not affect battle events.
 *
